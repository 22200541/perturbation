...
#### Download pre-computed gene Embeddings
    aws s3 sync --no-sign-request s3://czi-scgenept-public/models/gene_embeddings/GO_C_gene_embeddings-gpt3.5-ada-concat.pickle models/gene_embeddings/GO_C_gene_embeddings-gpt3.5-ada-concat.pickle

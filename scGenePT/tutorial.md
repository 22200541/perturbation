...
## Training
### LSF job
    bsub -J "scgenept" -Is -W 24:00 -q normal -gpu "num=1:mode=exclusive_process:mig=2" -n 2 -R "rusage[mem=10000]" bash

### Run
batch size 16으로 낮춤

    python train.py --model-type=scgenept_ncbi+uniprot_gpt --num-epochs=10 --dataset=norman --device=cuda:0 \

...
### 모델
1. scGen  
   scGen predicts single-cell perturbation responses (Lotfollahi, M. et al., 2019)  
   https://doi.org/10.1038/s41592-019-0494-8  
   https://github.com/theislab/scgen/blob/d79e1f04233c30f9a4eb5b8d57718127909807d7/docs/tutorials/scgen_perturbation_prediction.ipynb 
3. scGPT  
   scGPT: toward building a foundation model for single-cell multi-omics using generative AI (Cui, H. et al., 2024)  
